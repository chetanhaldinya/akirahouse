                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-5">
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="fs-5 text-gray-600">{{ isset($testimonial->name) ? $testimonial->name : 'Na' }}
                                </div>
                            </div>
                            <div class="col-md-6 fv-row">
                                <div class="fs-5 fw-bold mb-2">{{ trans_choice('content.designation', 1) }}</div>
                                <div class="fs-5 text-gray-600">
                                    {{ isset($testimonial->designation) ? $testimonial->designation : 'Na' }}</div>
                            </div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-5">
                            <div class="col-md-12 fv-row">
                                ...
                                <div class="fs-5 text-gray-600">
                                    {{ isset($testimonial->content) ? $testimonial->content : 'Na' }}</div>
                            </div>
                        </div>
                        <!--end::Input group-->
                            ...
                            <div class="row mb-5">
                                <div class="col-md-6 fv-row">
                                    ...
                                    <div class="fs-5 text-gray-600"><a
                                            href="{{ isset($testimonial->image) ? $testimonial->image : 'Na' }}"
                                            target="_blank">
                                            <div class="font-medium whitespace-no-wrap">
                                                <img src="{{ isset($testimonial->image) ? $testimonial->image : 'Na' }}"
