...
@section('content')
    @include('admin.layouts.components.header', [
        'title' => __('messages.list', [
            'name' => trans_choice('content.testimonial', 2),
        ]),
        'breadcrumbs' => Breadcrumbs::render('admin.testimonials.index'),
        'filter' => false,
        'create_btn' => [
            'status' => true,
    ...
    @include('admin.layouts.components.datatable_header', [
        'data' => [
            ...
            ['classname' => 'min-w-125px', 'title' => trans_choice('content.designation', 1)],
...
@push('scripts')
    <script>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            var edit_url = `{{ url('/') }}/admin/testimonials/` + row['id'] +
                                `/edit/?tab=edit`;
                            var show_url = `{{ url('/') }}/admin/testimonials/` + row['id'] +
                                `?tab=details`;
        ...
        $(document).on('click', '.clsstatus', function() {
            ...
            var url = `{{ url('/') }}/admin/testimonials/status/` + id + `/` + status;
