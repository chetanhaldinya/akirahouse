                ...
                <div id="kt_account_profile_details">
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="row mb-5">
                                <div class="col-md-6 fv-row">
                                    <div class="fs-5 fw-bold mb-2">{{ trans_choice('content.meta_title', 1) }}</div>
                            ...
                            <div class="row mb-5">
                                <div class="col-md-6 fv-row">
                                    <div class="fs-5 fw-bold mb-2">{{ trans_choice('content.description', 1) }}</div>
                            ...
                            <div class="row mb-5">
                                <div class="col-md-6 fv-row">
                                    <div class="fs-5 fw-bold mb-2">{{ trans_choice('content.meta_description', 1) }}</div>
