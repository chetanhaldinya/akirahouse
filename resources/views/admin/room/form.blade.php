...
<div class="card-body">
    ...
    <div class="row mb-6">
        ...
        <div class="col-lg-3 fv-row">
            @if (isset($room->image))
                <img id="backImage_image" width="80px" height="80px" src="{{ $room->image }}" title="Image">
            @else
    ...
    <div class="row mb-6">
        <div class="col-lg-7 fv-row" style="display: flex;">
            @if (!empty($room->room_images))
                @foreach ($room->room_images as $images)
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\RoomRequest', 'form') !!}
@endpush
