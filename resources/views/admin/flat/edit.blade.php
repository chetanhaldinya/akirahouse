...
@section('content')
    @include('admin.layouts.components.header', [
        ...
        'breadcrumbs' => Breadcrumbs::render('admin.flats.edit'),
    ])
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-lg-row mb-17">
                        ...
                        <div class="flex-lg-row-fluid me-0 me-lg-20">
                            ...
                            <!--begin::Form-->
                            {!! Form::model($flat, ['method' => 'PATCH', 'route' => ['admin.flats.update', $flat->id], 'class' => 'form mb-15', 'id' => 'form_editor', 'enctype' => 'multipart/form-data', 'onsubmit' => 'return checkForm(this);']) !!}
                            @csrf
