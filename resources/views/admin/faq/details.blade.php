                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-5">
                            <div class="col-md-6 fv-row">
                                <div class="fs-5 fw-bold mb-2">{{ trans_choice('content.question', 1) }}
                                </div>
                                <div class="fs-5 text-gray-600">{{ isset($faq->question) ? $faq->question : 'Na' }}
                                </div>
                            </div>
                            <div class="col-md-6 fv-row">
                                <div class="fs-5 fw-bold mb-2">{{ trans_choice('content.answer', 1) }}</div>
                                <div class="fs-5 text-gray-600">
                                    {{ isset($faq->answer) ? $faq->answer : 'Na' }}</div>
                            </div>
                        </div>
                        <!--end::Input group-->
                    </div>
