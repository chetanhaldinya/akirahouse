                ...
                <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ checkActiveSideBar(['blogs']) ? 'menu-item active' : '' }}"
                            ...
                            <span class="menu-title">{{ trans_choice('blog', 2) }}</span>
                        </a>
                    </div>
                    {{-- End::Blog Section --}}
                    {{-- Start::Image Section --}}
                     <div class="menu-item">
                        <a class="menu-link {{ checkActiveSideBar(['images']) ? 'menu-item active' : '' }}"
                            ...
                            <span class="menu-title">{{ trans_choice('content.image', 2) }}</span>
                        </a>
                    </div>
                    {{-- End::Image Section --}}
                </div>
