            ...
            <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                ...
                <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                    ...
                    {{-- End::Room Section --}}
                     {{-- Start::room Section --}}
                     <div class="menu-item">
                        <a class="menu-link {{ checkActiveSideBar(['rooms']) ? 'menu-item active' : '' }}"
                            ...
                            <span class="menu-title">{{ trans_choice('content.room', 2) }}</span>
                        </a>
                    </div>
                    {{-- End::Room Section --}}
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ checkActiveSideBar(['faqs']) ? 'menu-item active' : '' }}"
                            ...
                            <span class="menu-title">{{ trans_choice('faqs', 2) }}</span>
                        </a>
                    </div>
                    {{-- End::faq Section --}}
                                       ...
                                       <div class="menu-item">
                                        <a class="menu-link {{ checkActiveSideBar(['blogs']) ? 'menu-item active' : '' }}"
                                            ...
                                            <span class="menu-title">{{ trans_choice('blogs', 2) }}</span>
                                        </a>
                                    </div>
                                    {{-- End::blogs Section --}}
                </div>
